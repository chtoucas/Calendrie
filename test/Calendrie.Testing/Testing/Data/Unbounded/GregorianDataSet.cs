...
{
    public DataGroup<YemodaAnd<DayOfWeek>> DayOfWeekData { get; } =
    [
        // Epoch.
    ...
    public DataGroup<YemodaPairAnd<DayOfWeek>> DayOfWeek_Before_Data { get; } =
    [
    ...
    public DataGroup<YemodaPairAnd<DayOfWeek>> DayOfWeek_OnOrBefore_Data { get; } =
    [
        // Preceding days.
        new(new(2018, 12, 13), new(2018, 12,  7),  DayOfWeek.Friday ),
        new(new(2018, 12, 13), new(2018, 12,  8),  DayOfWeek.Saturday ),
    ...
    public DataGroup<YemodaPairAnd<DayOfWeek>> DayOfWeek_Nearest_Data { get; } =
    [
        // Preceding days.
    ...
    public DataGroup<YemodaPairAnd<DayOfWeek>> DayOfWeek_OnOrAfter_Data { get; } =
    [
        // Same day.
        new(new(2018, 12,  6), new(2018, 12,  6),  DayOfWeek.Thursday ),
        // Following days.
    ...
    public DataGroup<YemodaPairAnd<DayOfWeek>> DayOfWeek_After_Data { get; } =
    [
        // Following days.
        new(new(2018, 12,  6), new(2018, 12,  7),  DayOfWeek.Friday ),
        new(new(2018, 12,  6), new(2018, 12,  8),  DayOfWeek.Saturday ),
