...
public partial class FrenchRepublican13DataSet // Start and end of year
{
    ...
    [
        new(-3999, -(int)FrenchRepublicanSchema.DaysPer4000YearCycle),
        new(-10, -4017),
        new(-9, -3652),
        ...
        new(9, 2922),
        new(10, 3287),
        new(4001, (int)FrenchRepublicanSchema.DaysPer4000YearCycle),
    ];
}
...
{
    public DataGroup<YemodaAnd<int>> EpagomenalDayInfoData { get; } =
    [
        // Common year.
