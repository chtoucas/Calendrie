...
public partial class SystemArithmeticFacts<TDataSet> // Overflows
{
    ...
    public void AddDays﹍Yemoda_Overflows()
    {
        ...
        // Act & Assert
        AssertEx.Overflows(() => ArithmeticUT.AddDays(epoch, minDaysSinceEpoch - 1));
        _ = ArithmeticUT.AddDays(epoch, minDaysSinceEpoch);
        _ = ArithmeticUT.AddDays(epoch, maxDaysSinceEpoch);
        AssertEx.Overflows(() => ArithmeticUT.AddDays(epoch, maxDaysSinceEpoch + 1));
    }

    [Fact]
    public void AddDays﹍Yemoda_Overflows_AtStartOfMinYear() =>
        AssertEx.Overflows(() => ArithmeticUT.AddDays(Segment.MinMaxDateParts.LowerValue, -1));

    [Fact]
    public void AddDays﹍Yemoda_Overflows_AtEndOfMaxYear() =>
        AssertEx.Overflows(() => ArithmeticUT.AddDays(Segment.MinMaxDateParts.UpperValue, 1));

    [Fact]
    public void PreviousDay﹍Yemoda_Overflows_AtStartOfMinYear() =>
        AssertEx.Overflows(() => ArithmeticUT.PreviousDay(Segment.MinMaxDateParts.LowerValue));

    [Fact]
    public void NextDay﹍Yemoda_Overflows_AtEndOfMaxYear() =>
        AssertEx.Overflows(() => ArithmeticUT.NextDay(Segment.MinMaxDateParts.UpperValue));
    ...
    public void AddDays﹍Yedoy_Overflows_AtStartOfMinYear() =>
        AssertEx.Overflows(() => ArithmeticUT.AddDays(Segment.MinMaxOrdinalParts.LowerValue, -1));

    [Fact]
    public void AddDays﹍Yedoy_Overflows_AtEndOfMaxYear() =>
        AssertEx.Overflows(() => ArithmeticUT.AddDays(Segment.MinMaxOrdinalParts.UpperValue, 1));

    [Fact]
    public void PreviousDay﹍Yedoy_Overflows_AtStartOfMinYear() =>
        AssertEx.Overflows(() => ArithmeticUT.PreviousDay(Segment.MinMaxOrdinalParts.LowerValue));

    [Fact]
    public void NextDay﹍Yedoy_Overflows_AtEndOfMaxYear() =>
        AssertEx.Overflows(() => ArithmeticUT.NextDay(Segment.MinMaxOrdinalParts.UpperValue));
    ...
    public void AddMonths﹍Yemo_Overflows()
    {
        ...
        // Act & Assert
        AssertEx.Overflows(() => ArithmeticUT.AddMonths(epoch, minMonthsSinceEpoch - 1));
        _ = ArithmeticUT.AddMonths(epoch, minMonthsSinceEpoch);
        _ = ArithmeticUT.AddMonths(epoch, maxMonthsSinceEpoch);
        AssertEx.Overflows(() => ArithmeticUT.AddMonths(epoch, maxMonthsSinceEpoch + 1));
    }

    [Fact]
    public void AddMonths﹍Yemo_Overflows_AtStartOfMinYear() =>
        AssertEx.Overflows(() => ArithmeticUT.AddMonths(Segment.MinMaxMonthParts.LowerValue, -1));

    [Fact]
    public void AddMonths﹍Yemo_Overflows_AtEndOfMaxYear() =>
        AssertEx.Overflows(() => ArithmeticUT.AddMonths(Segment.MinMaxMonthParts.UpperValue, 1));

    [Fact]
    public void PreviousMonth﹍Yemo_Overflows_AtStartOfMinYear() =>
        AssertEx.Overflows(() => ArithmeticUT.PreviousMonth(Segment.MinMaxMonthParts.LowerValue));

    [Fact]
    public void NextMonth﹍Yemo_Overflows_AtEndOfMaxYear() =>
        AssertEx.Overflows(() => ArithmeticUT.NextMonth(Segment.MinMaxMonthParts.UpperValue));
}
