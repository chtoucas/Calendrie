...
public sealed partial class TropicaliaCalendar : Calendar
{
    ...
    /// </summary>
    public static DayNumber MaxDayNumber { get; } = DayZero.NewStyle + 3_652_055;
...
/// <para>This class cannot be inherited.</para>
/// </summary>
public sealed class TropicaliaClock : IClock
{
    /// <summary>
    ...
    /// </summary>
    public static TropicaliaClock Local { get; } = new(LocalSystemClock.Instance);
...
public partial struct TropicaliaDate // Preamble
{
    ...
    internal const int MaxDaysSinceZero = 3_652_055;
