...
public partial struct TropicaliaDate // Non-standard math ops
{
    ...
    public int CountMonthsSince(TropicaliaDate other)
    {
        ...
        int months = checked(TropicaliaSchema.MonthsPerYear * (y - y0) + m - m0);
...
public sealed class TropicaliaDateMath : DateMath<TropicaliaDate>
{
    ...
    private TropicaliaDateMath(AdditionRule rule) : base(rule) { }

    public static TropicaliaDateMath Truncate => new(AdditionRule.Truncate);

    public static TropicaliaDateMath Overspill => new(AdditionRule.Overspill);

    public static TropicaliaDateMath Exact => new(AdditionRule.Exact);
}
...
public partial struct TropicaliaMonth // Preamble
{
    ...
    public TropicaliaMonth(int year, int month)
    {
        ...
        if (month < 1 || month > TropicaliaSchema.MonthsPerYear)
    ...
    public int Year =>
        ...
        1 + _monthsSinceEpoch / TropicaliaSchema.MonthsPerYear;
    ...
    public void Deconstruct(out int year, out int month)
    {
        ...
        // NB: both dividend and divisor are >= 0.
        year = 1 + MathN.Divide(_monthsSinceEpoch, TropicaliaSchema.MonthsPerYear, out int m0);
        month = 1 + m0;
    }
}
...
public partial struct TropicaliaMonth // Factories
{
    ...
    public static TropicaliaMonth? TryCreate(int year, int month)
    {
        ...
        if (year < StandardScope.MinYear || year > StandardScope.MaxYear
            || month < 1 || month > TropicaliaSchema.MonthsPerYear)
        {
            return null;
        }
...
public partial struct TropicaliaMonth // Counting
{
    ...
    /// <inheritdoc />
    [Pure]
    public int CountRemainingMonthsInYear() => TropicaliaSchema.MonthsPerYear - Month;
...
public partial struct TropicaliaMonth // Adjustments
{
    ...
    public TropicaliaMonth WithMonth(int newMonth)
    {
        ...
        if (newMonth < 1 || newMonth > TropicaliaSchema.MonthsPerYear)
...
public partial struct TropicaliaYear // IMonthSegment
{
    ...
    /// </summary>
    public const int MonthCount = TropicaliaSchema.MonthsPerYear;
