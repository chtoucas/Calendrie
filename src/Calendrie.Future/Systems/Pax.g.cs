...
public sealed partial class PaxCalendar : Calendar
{
        ...
        : base(DisplayName, new StandardScope(schema, DayZero.SundayBeforeGregorian))
    {
        ...
        Debug.Assert(MaxDaysSinceEpoch == 3_652_060);
    ...
    /// </summary>
    public static DayNumber MaxDayNumber { get; } = DayZero.SundayBeforeGregorian + 3_652_060;
...
public partial struct PaxDate // Preamble
{
    ...
    internal const int MaxDaysSinceEpoch = 3_652_060;
...
public partial struct PaxDate // Standard math ops
{
    ...
    /// </summary>
    [Pure]
    public int CountWeeksSince(PaxDate other) => MathZ.Divide(CountDaysSince(other), DaysPerWeek);
    ...
    /// </exception>
    [Pure]
    public PaxDate PlusWeeks(int weeks) => PlusDays(DaysPerWeek * weeks);
    ...
    /// </summary>
    [Pure]
    public PaxDate NextWeek() => PlusDays(DaysPerWeek);
    ...
    /// </summary>
    [Pure]
    public PaxDate PreviousWeek() => PlusDays(-DaysPerWeek);
}
...
public partial struct PaxMonth // Preamble
{
    ...
    internal const int MaxMonthsSinceEpoch = 131_761;
