...
public readonly partial struct FrenchRepublican13Date :
    ...
    ICalendarBound<FrenchRepublican13Calendar>,
...
public partial struct FrenchRepublican13Date // Standard math ops
{
    ...
    /// </exception>
    [Pure]
    public FrenchRepublican13Date AddWeeks(int weeks) => PlusDays(DaysInWeek * weeks);
...
public partial struct FrenchRepublican13Date // Non-standard math ops
{
    ...
    public int CountMonthsSince(FrenchRepublican13Date other)
    {
        ...
        int months = checked(FrenchRepublican13Calendar.MonthsInYear * (y - y0) + m - m0);
    ...
    private static FrenchRepublican13Date AddMonths(FrenchRepublican13Schema sch, int y, int m, int d, int months)
    {
        ...
        int newM = 1 + MathZ.Modulo(checked(m - 1 + months), FrenchRepublican13Calendar.MonthsInYear, out int y0);
