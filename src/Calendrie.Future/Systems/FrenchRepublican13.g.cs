...
public sealed partial class FrenchRepublican13Calendar : Calendar
{
    ...
    /// </summary>
    public const int MonthsInYear = FrenchRepublican13Schema.MonthsInYear;
...
public partial struct FrenchRepublican13Date // Find close by day of the week
{
    /// <inheritdoc />
    [Pure]
...
public partial struct FrenchRepublican13Date // Non-standard math ops
{
    ...
    public int CountMonthsSince(FrenchRepublican13Date other)
    {
        ...
        int months = checked(FrenchRepublican13Schema.MonthsInYear * (y - y0) + m - m0);
    ...
    /// range of supported dates.</exception>
    [Pure]
    private static FrenchRepublican13Date AddYears(FrenchRepublican13Schema sch, int y, int m, int d, int years)
    {
    ...
    /// range of supported dates.</exception>
    [Pure]
    private static FrenchRepublican13Date AddMonths(FrenchRepublican13Schema sch, int y, int m, int d, int months)
    {
        // Exact addition of months to a calendar month.
        int newM = 1 + MathZ.Modulo(checked(m - 1 + months), FrenchRepublican13Schema.MonthsInYear, out int y0);
...
public partial struct FrenchRepublican13Month // Preamble
{
    ...
    public FrenchRepublican13Month(int year, int month)
    {
        ...
        if (month < 1 || month > FrenchRepublican13Schema.MonthsInYear)
    ...
    public int Year =>
        ...
        1 + _monthsSinceEpoch / FrenchRepublican13Schema.MonthsInYear;
    ...
    public void Deconstruct(out int year, out int month)
    {
        ...
        // NB: both dividend and divisor are >= 0.
        year = 1 + MathN.Divide(_monthsSinceEpoch, FrenchRepublican13Schema.MonthsInYear, out int m0);
        month = 1 + m0;
    }
}
...
public partial struct FrenchRepublican13Month // Factories
{
    ...
    public static FrenchRepublican13Month? TryCreate(int year, int month)
    {
        ...
        if (year < StandardScope.MinYear || year > StandardScope.MaxYear
            || month < 1 || month > FrenchRepublican13Schema.MonthsInYear)
        {
            return null;
        }
    ...
    private static int CountMonthsSinceEpoch(int y, int m) =>
        ...
        FrenchRepublican13Schema.MonthsInYear * (y - 1) + m - 1;
}
...
public partial struct FrenchRepublican13Month // Counting
{
    ...
    /// <inheritdoc />
    [Pure]
    public int CountRemainingMonthsInYear() => FrenchRepublican13Schema.MonthsInYear - Month;
...
public partial struct FrenchRepublican13Month // Adjustments
{
    ...
    public FrenchRepublican13Month WithMonth(int newMonth)
    {
        ...
        if (newMonth < 1 || newMonth > FrenchRepublican13Schema.MonthsInYear)
...
public partial struct FrenchRepublican13Month // Non-standard math ops
{
    ...
    /// a new month.
    /// <para>In the particular case of the FrenchRepublican13 calendar, this
...
public partial struct FrenchRepublican13Year // IMonthSegment
{
    ...
    /// </summary>
    public const int MonthCount = FrenchRepublican13Schema.MonthsInYear;
