...
public partial struct InternationalFixedDate // Non-standard math ops
{
    ...
    public int CountMonthsSince(InternationalFixedDate other)
    {
        ...
        int months = checked(InternationalFixedCalendar.MonthsInYear * (y - y0) + m - m0);
    ...
    private static InternationalFixedDate AddMonths(InternationalFixedSchema sch, int y, int m, int d, int months)
    {
        ...
        int newM = 1 + MathZ.Modulo(checked(m - 1 + months), InternationalFixedCalendar.MonthsInYear, out int y0);
