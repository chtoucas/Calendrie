...
public sealed partial class InternationalFixedCalendar : Calendar
{
    ...
    /// </summary>
    public const int MonthsInYear = InternationalFixedSchema.MonthsInYear;
...
public partial struct InternationalFixedDate // Find close by day of the week
{
    /// <inheritdoc />
    [Pure]
...
public partial struct InternationalFixedDate // Non-standard math ops
{
    ...
    /// range of supported dates.</exception>
    [Pure]
    private static InternationalFixedDate AddYears(InternationalFixedSchema sch, int y, int m, int d, int years)
    {
