...
public partial struct FrenchRepublicanDate // Preamble
{
    ...
    /// </summary>
    internal FrenchRepublicanDate(int daysSinceEpoch)
    {
...
public partial struct FrenchRepublicanDate // Factories & conversions
{
    /// <inheritdoc />
    [Pure]
    ...
    /// <inheritdoc />
    [Pure]
    public static FrenchRepublicanDate FromDayNumber(DayNumber dayNumber)
    {
...
public partial struct FrenchRepublicanDate // Standard math ops
{
    ...
    /// </exception>
    [Pure]
    public FrenchRepublicanDate AddWeeks(int weeks) => PlusDays(DaysInWeek * weeks);
...
public partial struct FrenchRepublicanDate // Non-standard math ops
{
    ...
    public int CountMonthsSince(FrenchRepublicanDate other)
    {
        ...
        int months = checked(FrenchRepublicanCalendar.MonthsInYear * (y - y0) + m - m0);
    ...
    private static FrenchRepublicanDate AddMonths(FrenchRepublican12Schema sch, int y, int m, int d, int months)
    {
        ...
        int newM = 1 + MathZ.Modulo(checked(m - 1 + months), FrenchRepublicanCalendar.MonthsInYear, out int y0);
