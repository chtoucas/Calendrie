...
public partial struct RevisedWorldDate // Factories & conversions
{
    /// <inheritdoc />
    [Pure]
...
public partial struct RevisedWorldDate // Non-standard math ops
{
    ...
    public int CountMonthsSince(RevisedWorldDate other)
    {
        ...
        int months = checked(RevisedWorldCalendar.MonthsInYear * (y - y0) + m - m0);
    ...
    private static RevisedWorldDate AddMonths(WorldSchema sch, int y, int m, int d, int months)
    {
        ...
        int newM = 1 + MathZ.Modulo(checked(m - 1 + months), RevisedWorldCalendar.MonthsInYear, out int y0);
