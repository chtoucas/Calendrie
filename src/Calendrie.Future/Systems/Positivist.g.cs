...
public sealed partial class PositivistCalendar : Calendar
{
    ...
    {
        Debug.Assert(Epoch.DaysSinceZero == 653_054);
#if DEBUG
...
public partial struct PositivistDate // Preamble
{
    ...
    internal const int EpochDaysSinceZero = 653_054;
...
public partial struct PositivistDate // Standard math ops
{
    ...
    /// </summary>
    [Pure]
    public int CountWeeksSince(PositivistDate other) => MathZ.Divide(CountDaysSince(other), DaysPerWeek);
    ...
    /// </exception>
    [Pure]
    public PositivistDate PlusWeeks(int weeks) => PlusDays(DaysPerWeek * weeks);
    ...
    /// </summary>
    [Pure]
    public PositivistDate NextWeek() => PlusDays(DaysPerWeek);
    ...
    /// </summary>
    [Pure]
    public PositivistDate PreviousWeek() => PlusDays(-DaysPerWeek);
}
...
public partial struct PositivistMonth // IDaySegment
{
    ...
    public Segment<PositivistDate> ToRange()
    {
        ...
        return Segment.StartingAt(PositivistDate.UnsafeCreate(startOfMonth), daysInMonth);
    }
...
public partial struct PositivistYear // IMonthSegment
{
    ...
    /// <inheritdoc />
    [Pure]
    public Segment<PositivistMonth> ToMonthRange() => Segment.StartingAt(MinMonth, MonthCount);
...
public partial struct PositivistYear // IDaySegment
{
    ...
    public Segment<PositivistDate> ToDayRange()
    {
        ...
        return Segment.StartingAt(PositivistDate.UnsafeCreate(startOfYear), daysInYear);
    }
