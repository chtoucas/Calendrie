...
public partial struct WorldMonth // IDaySegment
{
    ...
    public Segment<WorldDate> ToRange()
    {
        ...
        return Segment.StartingAt(WorldDate.UnsafeCreate(startOfMonth), daysInMonth);
    }
...
public partial struct WorldYear // IMonthSegment
{
    ...
    /// <inheritdoc />
    [Pure]
    public Segment<WorldMonth> ToMonthRange() => Segment.StartingAt(MinMonth, MonthCount);
...
public partial struct WorldYear // IDaySegment
{
    ...
    public Segment<WorldDate> ToDayRange()
    {
        ...
        return Segment.StartingAt(WorldDate.UnsafeCreate(startOfYear), daysInYear);
    }
