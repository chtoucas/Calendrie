...
public partial class MyCivilCalendar // Math
{
    /// <summary>
    ...
    [Pure]
    internal MyCivilDate AddYears(int y, int m, int d, int years)
    {
        var sch = Schema;
    ...
    /// range of supported dates.</exception>
    [Pure]
    internal MyCivilDate AddYears(int y, int m, int d, int years, out int roundoff)
    {
        var sch = Schema;
    ...
    /// range of supported dates.</exception>
    [Pure]
    internal MyCivilDate AddMonths(int y, int m, int d, int months)
    {
        // Exact addition of months to a calendar month.
        int newM = 1 + MathZ.Modulo(
            checked(m - 1 + months), GregorianSchema.MonthsPerYear, out int years);
    ...
    /// range of supported dates.</exception>
    [Pure]
    internal MyCivilDate AddMonths(int y, int m, int d, int months, out int roundoff)
    {
        // Exact addition of months to a calendar month.
        int newM = 1 + MathZ.Modulo(
            checked(m - 1 + months), GregorianSchema.MonthsPerYear, out int years);
...
public partial struct MyCivilDate // Non-standard math ops
{
    ...
    /// range of supported dates.</exception>
    [Pure]
    public MyCivilDate PlusYears(int years, out int roundoff)
    {
        var chr = Calendar;
        chr.Schema.GetDateParts(_daysSinceZero, out int y, out int m, out int d);
    ...
    /// range of supported dates.</exception>
    [Pure]
    public MyCivilDate PlusMonths(int months, out int roundoff)
    {
        var sch = Calendar.Schema;
        sch.GetDateParts(_daysSinceZero, out int y, out int m, out int d);
    ...
    public int CountMonthsSince(MyCivilDate other)
    {
        ...
        int months = checked(GregorianSchema.MonthsPerYear * (y - y0) + m - m0);
...
/// </para>
/// </summary>
public sealed class MyCivilDateMath : DateMath<MyCivilDate>
{
    /// <summary>
    ...
    private MyCivilDateMath(AdditionRule rule) : base(rule) { }

    public static MyCivilDateMath Truncate => new(AdditionRule.Truncate);

    public static MyCivilDateMath Overspill => new(AdditionRule.Overspill);

    public static MyCivilDateMath Exact => new(AdditionRule.Exact);
}
...
public partial struct MyCivilMonth // Preamble
{
    ...
    public int Year =>
        ...
        1 + _monthsSinceEpoch / GregorianSchema.MonthsPerYear;
    ...
    public void Deconstruct(out int year, out int month)
    {
        ...
        // NB: both dividend and divisor are >= 0.
        year = 1 + MathN.Divide(_monthsSinceEpoch, GregorianSchema.MonthsPerYear, out int m0);
        month = 1 + m0;
    }
}
