...
public abstract class TropicalistaDataSet : SchemaDataSet
{
    ...
    public sealed override DataGroup<YearInfo> YearInfoData { get; } =
    [
        // Leap years.
        new(-8, 12, 366, true),
        new(-4, 12, 366, true),
    ...
    public sealed override DataGroup<YearDaysSinceEpoch> StartOfYearDaysSinceEpochData { get; } =
    [
        ...
        new(9, 8 * 365 + 2),
        new(10, 9 * 365 + 2),
        new(129, TropicalistaSchema.DaysPer128YearCycle),
    ];
