...
public class GregorianMathDataSetCutOff : IAdvancedMathDataSet, ISingleton<GregorianMathDataSetCutOff>
{
    ...
    public DataGroup<YemodaPairAnd<int>> AddYearsData { get; } =
    [
    ...
    public DataGroup<YemodaPairAnd<int>> AddMonthsData { get; } =
    [
    ...
    public DataGroup<YedoyPairAnd<int>> AddYearsOrdinalData { get; } =
    [
