...
{
    protected ICalendricalCoreFacts(TKernel schema)
    {
...
public partial class ICalendricalCoreFacts<TKernel, TDataSet> // Abstract
{
...
public partial class ICalendricalCoreFacts<TKernel, TDataSet> // Methods
{
