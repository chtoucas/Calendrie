...
/// <summary>
/// This form encodes the sequence of lengths of the centuries in a calendrical
/// cycle.
/// <para>To build such a form, we must in general change the origin of centuries
/// (the epoch) such that the exceptionnal century becomes the last one.</para>
/// </summary>
    ...
    : CalendricalForm(DaysPerCycle, CenturiesPerCycle, Remainder)
{
    ...
    /// the specified century.
    /// </summary>
    [Pure]
    public int GetStartOfCentury(int c) => ValueAt(c);

    /// <summary>
    /// Obtains the century of the specified count of consecutive days since the
    /// epoch.
    /// </summary>
    [Pure]
