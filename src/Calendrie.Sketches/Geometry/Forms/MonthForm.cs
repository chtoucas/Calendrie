...
/// <para>To build such a form, we must in general change the origin of months
/// such that the exceptionnal month holding the intercalary days becomes the
/// last one.</para>
/// </summary>
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="MonthForm"/> record with
    /// the default (algebraic) numbering system.
    /// </summary>
