...
/// <summary>
/// This form encodes the (trivial) sequence of the days of a month, ie 0, 1, 2,
/// and so forth.
/// <para>Elle a pour rôle de déplacer l'origine de la numérotation des jours du
/// mois de 0 à 1.</para>
/// </summary>
public sealed record DayForm : CalendricalForm
{
    ...
    /// and before the specified day of the month.
    /// <para>Equivalently, it returns the algebraic day of the month of the
    /// specified (ordinary) day of the month.</para>
    /// </summary>
    [Pure]
    public static int CountDaysInMonthBeforeDay(int d) => d - 1;

    /// <summary>
    /// Obtains the (ordinary) day of the month of the specified algebraic day
    /// of the month.
    /// </summary>
    [Pure]
