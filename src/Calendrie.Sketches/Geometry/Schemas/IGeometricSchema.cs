...
public interface IGeometricSchema
{
    ...
    /// <summary>
    /// Obtains the year, month and day of the month for the specified day count
    /// (the number of consecutive days from the epoch to a date); the results
    /// are given in output parameters.
    /// <para>This method does NOT validate its parameter.</para>
    /// </summary>
