...
public class SecondOrderSchemaExt
{
    ...
    /// <para>Retourne le nombre de jours entre le début d'une année bissextile
    /// et la fin du mois.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <see cref="CountDaysInLeapYearAtEndOfMonth(int)"/>, néanmoins ça ne pose
    /// aucun problème à partir du moment où on se contente de
    /// <see cref="GeometricSchema.CountDaysInYearBeforeMonth(int)"/>.
    /// </para>
    /// </remarks>
    [Pure]
