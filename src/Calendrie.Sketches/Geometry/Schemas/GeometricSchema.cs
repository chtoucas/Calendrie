...
public abstract partial class GeometricSchema : IGeometricSchema
{
    protected GeometricSchema(YearForm yearForm, MonthForm monthForm)
    {
        ...
        if (yearForm.Origin != monthForm.Origin)
        {
            ...
            throw new ArgumentException(null, nameof(yearForm));
        }
    }
...
public partial class GeometricSchema
{
    ...
    /// début du mois.</para>
    /// <para>Comme les jours bissextils sont placés en fin d'année, le résultat
    /// ne dépend pas de l'année, ni du fait que la forme des mois soit celle
    /// des années communes ou celle des années bissextiles !</para>
    /// </summary>
    [Pure]
