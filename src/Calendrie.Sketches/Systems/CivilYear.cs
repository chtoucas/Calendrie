...
public partial struct CivilYear // Preamble
{
    ...
    /// </summary>
    private CivilYear(YearsSinceEpoch yearsSinceEpoch)
    {
...
{
    /// <inheritdoc />
    public static bool operator ==(CivilYear left, CivilYear right) => left._yearsSinceEpoch == right._yearsSinceEpoch;
