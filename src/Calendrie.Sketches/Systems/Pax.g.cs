...
public sealed partial class PaxCalendar : CalendarSystem<PaxDate>
{
    ...
    /// Gets the schema.
    /// </summary>
    internal PaxSchema UnderlyingSchema { get; }
}
...
public partial struct PaxDate // Preamble
{
    ...
    private static readonly int s_MinDaysSinceEpoch = PaxCalendar.Instance.MinDaysSinceEpoch;
    /// <summary>Represents the maximum value of <see cref="_daysSinceEpoch"/>.</summary>
    private static readonly int s_MaxDaysSinceEpoch = PaxCalendar.Instance.MaxDaysSinceEpoch;

    /// <summary>Represents the minimum value of the current type.</summary>
    private static readonly PaxDate s_MinValue = new(s_MinDaysSinceEpoch);
    /// <summary>Represents the maximum value of the current type.</summary>
    private static readonly PaxDate s_MaxValue = new(s_MaxDaysSinceEpoch);
    ...
    public static PaxDate MinValue => s_MinValue;

    /// <inheritdoc />
    /// <remarks>This static property is thread-safe.</remarks>
    public static PaxDate MaxValue => s_MaxValue;
...
public partial struct PaxDate // Math
{
    ...
    public static PaxDate operator +(PaxDate value, int days) => value.AddDays(days);
    ...
    /// <inheritdoc />
    [Pure]
    public PaxDate AddDays(int days)
    {
