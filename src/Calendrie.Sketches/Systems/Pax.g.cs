...
public partial struct PaxDate // Non-standard math ops
{
    ...
    /// </summary>
    [Pure]
    public int CountMonthsSince(PaxDate other) => Calendar.CountMonthsBetween(other, this);
    ...
    /// </summary>
    [Pure]
    public PaxDate PlusMonths(int months) => Calendar.AddMonths(this, months);

    /// <summary>
    /// Counts the number of years elapsed since the specified date.
    /// </summary>
    [Pure]
    public int CountYearsSince(PaxDate other) => Calendar.CountYearsBetween(other, this);
    ...
    /// </summary>
    [Pure]
    public PaxDate PlusYears(int years) => Calendar.AddYears(this, years);
}
