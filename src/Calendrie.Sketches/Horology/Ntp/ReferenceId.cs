...
public readonly partial struct ReferenceId :
    IEqualityOperators<ReferenceId, ReferenceId, bool>,
    IEquatable<ReferenceId>
{
...
public partial struct ReferenceId
{
    ...
    private static readonly HashSet<string> s_Codes =
    [
        // RFC 5905 Section 7.3, p.21.
    ...
    private static readonly HashSet<string> s_KissCodes =
    [
    ...
    {
        string code = Encoding.ASCII.GetString(bytes);
        var codeType =
