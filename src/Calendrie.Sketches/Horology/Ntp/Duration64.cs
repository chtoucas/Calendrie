    ...
    IDivisionOperators<Duration64, int, Duration64>
{
    ...
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    public static Duration64 MinValue { get; } = new(long.MinValue);

    /// <summary>
    /// Gets the largest possible value of a <see cref="Duration64"/>.
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    public static Duration64 MaxValue { get; } = new(long.MaxValue);
...
public partial struct Duration64 // IComparable
{
    ...
    int IComparable.CompareTo(object? obj) =>
        ...
        : ThrowHelpers.ThrowNonComparable(typeof(Duration64), obj);
}
