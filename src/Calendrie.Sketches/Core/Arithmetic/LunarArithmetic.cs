...
/// </summary>
internal sealed class LunarArithmetic : CalendricalArithmetic
{
    private const int MonthsInYear = CalendricalConstants.Lunar.MonthsInYear;

    /// <summary>
    /// Initializes a new instance of the <see cref="LunarArithmetic"/> class
    ...
    public LunarArithmetic(CalendricalSegment segment) : base(segment)
    {
