...
{
    private const int MonthsInYear = CalendricalConstants.Solar13.MonthsInYear;
    ...
    /// the expected profile <see cref="CalendricalProfile.Solar13"/>.</exception>
    public Solar13Arithmetic(CalendricalSegment segment) : base(segment)
    {
