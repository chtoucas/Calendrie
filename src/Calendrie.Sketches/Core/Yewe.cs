...
/// <para>This type uses the lexicographic order on pairs (Year, WeekOfYear).
/// </para>
/// <para>A <see cref="Yewe"/> value is NOT an ordinal date since it is not
/// attached to any calendar. As such, comparison between two instances is NOT
/// calendrical. Still, it uses an order that most of the time matches the
/// calendrical one.</para>
/// </summary>
[DebuggerDisplay("{" + nameof(DebuggerDisplay) + ",nq}")]
public readonly partial struct Yewe :
#if ENABLE_SERIALIZATION
    ISerializable<Yewe, int>,
#endif
    IEquatable<Yewe>,
    IComparable<Yewe>,
    IComparable
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Yewe"/> struct from the
    /// specified year and week of year.
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Yewe"/> struct directly from
    ...
    /// <summary>
    /// Gets the ordinal parts for the first week of the year to which belongs
    /// this instance.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new instance of <see cref="Yewe"/> from the specified year and
    /// week of year.
    /// </summary>
    ...
    internal static Yewe Create(int year, int weekOfYear)
    {
        ...
        {
            ThrowHelpers.ThrowWeekOfYearOutOfRange(weekOfYear);
        }
    ...
    /// <summary>
    /// Creates a new instance of <see cref="Yewe"/> representing the first week
...
{
    /// <summary>
    /// Determines whether two specified instances of <see cref="Yewe"/> are
    /// equal.
    /// </summary>
    public static bool operator ==(Yewe left, Yewe right) => left._bin == right._bin;

    /// <summary>
    /// Determines whether two specified instances of <see cref="Yewe"/> are not
    /// equal.
    /// </summary>
    public static bool operator !=(Yewe left, Yewe right) => left._bin != right._bin;
...
public partial struct Yewe // IComparable
{
    ...
    /// <para>The comparison is done using the lexicographic order on pairs
    /// (Year, WeekOfYear).</para>
    /// </summary>
    public static bool operator <(Yewe left, Yewe right) => left._bin < right._bin;
    ...
    int IComparable.CompareTo(object? obj) =>
        ...
        : ThrowHelpers.ThrowNonComparable(typeof(Yewe), obj);
}
