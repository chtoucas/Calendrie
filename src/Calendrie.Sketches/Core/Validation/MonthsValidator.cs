...
public sealed class MonthsValidator : IRangeValidator
{
    ...
    public void Validate(int monthsSinceEpoch, string? paramName = null)
    {
        if (monthsSinceEpoch < MinMonthsSinceEpoch || monthsSinceEpoch > MaxMonthsSinceEpoch)
            throw new ArgumentOutOfRangeException(paramName ?? nameof(monthsSinceEpoch));
    }

    /// <summary>
    /// Checks whether the specified number of consecutive months from the epoch
    /// is outside the range of supported values or not.
    /// </summary>
    /// <exception cref="OverflowException"><paramref name="monthsSinceEpoch"/>
    ...
    /// <summary>
    /// Checks whether the specified number of consecutive months from the epoch
    /// is greater than the upper bound of the range of supported values or not.
    /// </summary>
    /// <exception cref="OverflowException"><paramref name="monthsSinceEpoch"/>
    /// is greater than the upper bound of the range of supported values.
    /// </exception>
    ...
    /// <summary>
    /// Checks whether the specified number of consecutive months from the epoch
    /// is less than the lower bound of the range of supported values or not.
    /// </summary>
    /// <exception cref="OverflowException"><paramref name="monthsSinceEpoch"/>
    /// is less than the lower bound of the range of supported values.
    /// </exception>
