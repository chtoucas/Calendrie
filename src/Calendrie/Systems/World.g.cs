...
public partial struct WorldDate // Factories
{
    ...
    static WorldDate IFixedDateFactory<WorldDate>.FromDayNumberUnchecked(DayNumber dayNumber) =>
...
public partial struct WorldDate // Adjustments
{
    ...
    /// <inheritdoc />
    [Pure]
    public WorldDate WithYear(int newYear) => Adjuster.AdjustYear(this, newYear);

    /// <inheritdoc />
    [Pure]
    public WorldDate WithMonth(int newMonth) => Adjuster.AdjustMonth(this, newMonth);

    /// <inheritdoc />
    [Pure]
    public WorldDate WithDay(int newDay) => Adjuster.AdjustDay(this, newDay);

    /// <inheritdoc />
    [Pure]
    public WorldDate WithDayOfYear(int newDayOfYear) => Adjuster.AdjustDayOfYear(this, newDayOfYear);

    /// <inheritdoc />
    [Pure]
    public WorldDate Previous(DayOfWeek dayOfWeek) => Adjuster.Previous(this, dayOfWeek);

    /// <inheritdoc />
    [Pure]
    public WorldDate PreviousOrSame(DayOfWeek dayOfWeek) => Adjuster.PreviousOrSame(this, dayOfWeek);

    /// <inheritdoc />
    [Pure]
    public WorldDate Nearest(DayOfWeek dayOfWeek) => Adjuster.Nearest(this, dayOfWeek);

    /// <inheritdoc />
    [Pure]
    public WorldDate NextOrSame(DayOfWeek dayOfWeek) => Adjuster.NextOrSame(this, dayOfWeek);

    /// <inheritdoc />
    [Pure]
    public WorldDate Next(DayOfWeek dayOfWeek) => Adjuster.Next(this, dayOfWeek);
}
