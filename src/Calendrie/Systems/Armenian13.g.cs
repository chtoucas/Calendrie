...
public sealed partial class Armenian13Calendar : CalendarSystem<Armenian13Date>
{
    ...
    /// </summary>
    public DateAdjuster<Armenian13Date> Adjuster { get; }
...
public readonly partial struct Armenian13Date :
    ...
    IFixedDateFactory<Armenian13Date>,
...
public partial struct Armenian13Date // Preamble
{
    ...
    private static readonly int s_EpochDaysSinceZero = Armenian13Calendar.UnderlyingScope.Epoch.DaysSinceZero;
    ...
    /// </summary>
    public static DateAdjuster<Armenian13Date> Adjuster => Armenian13Calendar.Instance.Adjuster;
...
public partial struct Armenian13Date // Factories
{
    ...
    static Armenian13Date IFixedDateFactory<Armenian13Date>.FromDayNumberUnchecked(DayNumber dayNumber) =>
        new(dayNumber.DaysSinceZero - s_EpochDaysSinceZero);

    /// <inheritdoc />
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    static Armenian13Date IFixedDateFactory<Armenian13Date>.FromDaysSinceEpochUnchecked(int daysSinceEpoch) =>
        new(daysSinceEpoch);
}
...
public partial struct Armenian13Date // Adjustments
{
    ...
    /// <inheritdoc />
    [Pure]
    public Armenian13Date WithYear(int newYear) => Adjuster.AdjustYear(this, newYear);

    /// <inheritdoc />
    [Pure]
    public Armenian13Date WithMonth(int newMonth) => Adjuster.AdjustMonth(this, newMonth);

    /// <inheritdoc />
    [Pure]
    public Armenian13Date WithDay(int newDay) => Adjuster.AdjustDay(this, newDay);

    /// <inheritdoc />
    [Pure]
    public Armenian13Date WithDayOfYear(int newDayOfYear) => Adjuster.AdjustDayOfYear(this, newDayOfYear);

    /// <inheritdoc />
    [Pure]
    public Armenian13Date Previous(DayOfWeek dayOfWeek) => Adjuster.Previous(this, dayOfWeek);

    /// <inheritdoc />
    [Pure]
    public Armenian13Date PreviousOrSame(DayOfWeek dayOfWeek) => Adjuster.PreviousOrSame(this, dayOfWeek);

    /// <inheritdoc />
    [Pure]
    public Armenian13Date Nearest(DayOfWeek dayOfWeek) => Adjuster.Nearest(this, dayOfWeek);

    /// <inheritdoc />
    [Pure]
    public Armenian13Date NextOrSame(DayOfWeek dayOfWeek) => Adjuster.NextOrSame(this, dayOfWeek);

    /// <inheritdoc />
    [Pure]
    public Armenian13Date Next(DayOfWeek dayOfWeek) => Adjuster.Next(this, dayOfWeek);
}
