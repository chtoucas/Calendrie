...
#region FrenchRepublicanClock

/// <summary>
/// Represents a clock for the French Republican calendar.
/// <para>This class cannot be inherited.</para>
/// </summary>
public sealed partial class FrenchRepublicanClock : IClock
{
    /// <summary>
    /// Initializes a new instance of the <see cref="FrenchRepublicanClock"/> class.
    /// </summary>
    /// <exception cref="ArgumentNullException"><paramref name="clock"/> is
    /// <see langword="null"/>.</exception>
    public FrenchRepublicanClock(IClock clock)
    {
    ...
    /// <summary>
    /// Gets an instance of the <see cref="FrenchRepublicanClock"/> class for the
    /// system clock using the current time zone setting on this machine.
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    public static FrenchRepublicanClock Local { get; } = new(LocalSystemClock.Instance);
    ...
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    public static FrenchRepublicanClock Utc { get; } = new(UtcSystemClock.Instance);
    ...
    /// <summary>
    /// Obtains a <see cref="FrenchRepublicanDate"/> value representing the current date.
    /// </summary>
    [Pure]
    public FrenchRepublicanDate GetCurrentDate() => FrenchRepublicanDate.FromAbsoluteDate(Clock.Today());

    /// <summary>
    /// Obtains a <see cref="FrenchRepublicanMonth"/> value representing the current month.
    /// </summary>
    [Pure]
    public FrenchRepublicanMonth GetCurrentMonth() => FrenchRepublicanMonth.FromDate(GetCurrentDate());

    /// <summary>
    /// Obtains a <see cref="FrenchRepublicanYear"/> value representing the current year.
    /// </summary>
    [Pure]
    public FrenchRepublicanYear GetCurrentYear() => FrenchRepublicanYear.FromDate(GetCurrentDate());
}
