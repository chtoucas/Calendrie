...
public partial struct Persian2820Date // Non-standard math ops
{
    ...
    /// range of supported dates.</exception>
    [Pure]
    private static Persian2820Date AddYears(Persian2820Schema sch, int y, int m, int d, int years)
    {
    ...
    private static Persian2820Date AddMonths(Persian2820Schema sch, int y, int m, int d, int months)
    {
        ...
        int newM = 1 + MathZ.Modulo(checked(m - 1 + months), Persian2820Schema.MonthsPerYear, out int y0);
