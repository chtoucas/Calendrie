...
public sealed partial class Persian2820Calendar : Calendar
{
    ...
    /// </summary>
    public const int MonthsInYear = Persian2820Schema.MonthsInYear;
...
public partial struct Persian2820Month // Preamble
{
    ...
    public Persian2820Month(int year, int month)
    {
        ...
        if (month < 1 || month > Persian2820Schema.MonthsInYear)
    ...
    public int Year =>
        ...
        1 + _monthsSinceEpoch / Persian2820Schema.MonthsInYear;
    ...
    public void Deconstruct(out int year, out int month)
    {
        ...
        // NB: both dividend and divisor are >= 0.
        year = 1 + MathN.Divide(_monthsSinceEpoch, Persian2820Schema.MonthsInYear, out int m0);
        month = 1 + m0;
    }
}
...
public partial struct Persian2820Month // Factories
{
    ...
    public static Persian2820Month? TryCreate(int year, int month)
    {
        ...
        if (year < StandardScope.MinYear || year > StandardScope.MaxYear
            || month < 1 || month > Persian2820Schema.MonthsInYear)
        {
            return null;
        }
    ...
    private static int CountMonthsSinceEpoch(int y, int m) =>
        ...
        Persian2820Schema.MonthsInYear * (y - 1) + m - 1;
}
...
public partial struct Persian2820Month // Counting
{
    ...
    /// <inheritdoc />
    [Pure]
    public int CountRemainingMonthsInYear() => Persian2820Schema.MonthsInYear - Month;
...
public partial struct Persian2820Month // Adjustments
{
    ...
    public Persian2820Month WithMonth(int newMonth)
    {
        ...
        if (newMonth < 1 || newMonth > Persian2820Schema.MonthsInYear)
...
public partial struct Persian2820Year // IMonthSegment
{
    ...
    /// </summary>
    public const int MonthCount = Persian2820Schema.MonthsInYear;
