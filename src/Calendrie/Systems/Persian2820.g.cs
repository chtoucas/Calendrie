...
/// </summary>
public sealed partial class Persian2820Calendar : Calendar
{
    /// <summary>
    ...
    /// </summary>
    public Persian2820Calendar() : this(new Persian2820Schema()) { }
    ...
    /// <summary>
    /// Gets a singleton instance of the <see cref="Persian2820Calendar"/> class.
    /// <para>See <see cref="Persian2820Date.Calendar"/>.</para>
    /// </summary>
    internal static Persian2820Calendar Instance { get; } = new();
...
public partial class Persian2820Calendar // Math
{
    /// <summary>
    ...
    [Pure]
    internal Persian2820Date AddYears(int y, int m, int d, int years)
    {
        var sch = Schema;
        ...
        return Persian2820Date.UnsafeCreate(daysSinceEpoch);
    }
    ...
    /// range of supported dates.</exception>
    [Pure]
    internal Persian2820Date AddYears(int y, int m, int d, int years, out int roundoff)
    {
        var sch = Schema;
    ...
    /// range of supported dates.</exception>
    [Pure]
    internal Persian2820Date AddMonths(int y, int m, int d, int months)
    {
        // Exact addition of months to a calendar month.
        int newM = 1 + MathZ.Modulo(
            checked(m - 1 + months), Persian2820Schema.MonthsPerYear, out int years);
    ...
    /// range of supported dates.</exception>
    [Pure]
    internal Persian2820Date AddMonths(int y, int m, int d, int months, out int roundoff)
    {
        // Exact addition of months to a calendar month.
        int newM = 1 + MathZ.Modulo(
            checked(m - 1 + months), Persian2820Schema.MonthsPerYear, out int years);
...
public partial struct Persian2820Date // Preamble
{
    ...
    public Persian2820Date(int year, int month, int day)
    {
        var chr = Persian2820Calendar.Instance;
    ...
    public Persian2820Date(int year, int dayOfYear)
    {
        var chr = Persian2820Calendar.Instance;
    ...
    /// <summary>
    /// Gets the smallest possible value of <see cref="Persian2820Date"/>.
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    /// <returns>The earliest supported date.</returns>
    //
    // MinValue = new(0) = new() = default(Persian2820Date)
    public static Persian2820Date MinValue { get; }

    /// <summary>
    /// Gets the largest possible value of <see cref="Persian2820Date"/>.
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    ...
    public override string ToString()
    {
        ...
        return FormattableString.Invariant($"{d:D2}/{m:D2}/{y:D4} ({Persian2820Calendar.DisplayName})");
    }
...
public partial struct Persian2820Date // Factories
{
    /// <inheritdoc />
    [Pure]
    public static Persian2820Date Create(int year, int month, int day) => new(year, month, day);

    /// <inheritdoc />
    [Pure]
    public static Persian2820Date Create(int year, int dayOfYear) => new(year, dayOfYear);

    /// <summary>
    /// Attempts to create a new instance of the <see cref="Persian2820Date"/>
    /// struct from the specified date components.
    /// </summary>
    [Pure]
    public static Persian2820Date? TryCreate(int year, int month, int day)
    {
        var chr = Calendar;
        ...
        return new Persian2820Date(daysSinceEpoch);
    }
    ...
    /// </summary>
    [Pure]
    public static Persian2820Date? TryCreate(int year, int dayOfYear)
    {
        var chr = Calendar;
    ...
    // Explicit implementation: Persian2820Date being a value type, better
    // to use the others TryCreate().

    [Pure]
    static bool IDate<Persian2820Date>.TryCreate(int year, int month, int day, out Persian2820Date result)
    {
    ...
    [Pure]
    static bool IDate<Persian2820Date>.TryCreate(int year, int dayOfYear, out Persian2820Date result)
    {
...
{
    /// <summary>
    /// Defines an implicit conversion of a <see cref="Persian2820Date"/> value
    ...
    public static implicit operator DayNumber(Persian2820Date date) => date.DayNumber;
    ...
    [Pure]
    public static Persian2820Date FromAbsoluteDate(DayNumber dayNumber)
    {
    ...
    [Pure]
    static Persian2820Date IAbsoluteDate<Persian2820Date>.FromDayNumber(DayNumber dayNumber) =>
...
public partial struct Persian2820Date // Counting
{
    /// <inheritdoc />
    [Pure]
...
public partial struct Persian2820Date // Adjustments
{
    /// <inheritdoc />
    [Pure]
    public Persian2820Date WithYear(int newYear)
    {
        var chr = Calendar;
        var sch = Calendar.Schema;
    ...
    /// <inheritdoc />
    [Pure]
    public Persian2820Date WithMonth(int newMonth)
    {
        var chr = Calendar;
        var sch = Calendar.Schema;
    ...
    /// <inheritdoc />
    [Pure]
    public Persian2820Date WithDay(int newDay)
    {
        var chr = Calendar;
        var sch = Calendar.Schema;
    ...
    /// <inheritdoc />
    [Pure]
    public Persian2820Date WithDayOfYear(int newDayOfYear)
    {
        var chr = Calendar;
        var sch = Calendar.Schema;
...
public partial struct Persian2820Date // Find a close by day of the week
{
    /// <inheritdoc />
    [Pure]
    public Persian2820Date Previous(DayOfWeek dayOfWeek)
    {
    ...
    /// <inheritdoc />
    [Pure]
    public Persian2820Date PreviousOrSame(DayOfWeek dayOfWeek)
    {
        Requires.Defined(dayOfWeek);
    ...
    /// <inheritdoc />
    [Pure]
    public Persian2820Date Nearest(DayOfWeek dayOfWeek)
    {
    ...
    /// <inheritdoc />
    [Pure]
    public Persian2820Date NextOrSame(DayOfWeek dayOfWeek)
    {
        Requires.Defined(dayOfWeek);
    ...
    /// <inheritdoc />
    [Pure]
    public Persian2820Date Next(DayOfWeek dayOfWeek)
    {
        Requires.Defined(dayOfWeek);
...
public partial struct Persian2820Date // IEquatable
{
    /// <inheritdoc />
    public static bool operator ==(Persian2820Date left, Persian2820Date right) =>
    ...
    /// <inheritdoc />
    [Pure]
    public bool Equals(Persian2820Date other) => _daysSinceEpoch == other._daysSinceEpoch;

    /// <inheritdoc />
    [Pure]
    public override bool Equals([NotNullWhen(true)] object? obj) =>
        obj is Persian2820Date date && Equals(date);
...
public partial struct Persian2820Date // IComparable
{
    /// <summary>
    ...
    /// <inheritdoc />
    [Pure]
    public static Persian2820Date Min(Persian2820Date x, Persian2820Date y) => x < y ? x : y;

    /// <inheritdoc />
    [Pure]
    public static Persian2820Date Max(Persian2820Date x, Persian2820Date y) => x > y ? x : y;

    /// <inheritdoc />
    [Pure]
    public int CompareTo(Persian2820Date other) => _daysSinceEpoch.CompareTo(other._daysSinceEpoch);

    [Pure]
    int IComparable.CompareTo(object? obj) =>
        obj is null ? 1
        : obj is Persian2820Date date ? CompareTo(date)
        : ThrowHelpers.ThrowNonComparable(typeof(Persian2820Date), obj);
}

public partial struct Persian2820Date // Standard math ops
{
    /// <summary>
    ...
    public static int operator -(Persian2820Date left, Persian2820Date right) => left.CountDaysSince(right);
    ...
    public static Persian2820Date operator +(Persian2820Date value, int days) => value.PlusDays(days);
    ...
    public static Persian2820Date operator ++(Persian2820Date value) => value.NextDay();
    ...
    /// </exception>
    [Pure]
    public Persian2820Date PlusDays(int days)
    {
    ...
    /// latest supported date.</exception>
    [Pure]
    public Persian2820Date NextDay()
    {
        if (_daysSinceEpoch == MaxDaysSinceEpoch) ThrowHelpers.ThrowDateOverflow();
        return new Persian2820Date(_daysSinceEpoch + 1);
    }
    ...
    /// earliest supported date.</exception>
    [Pure]
    public Persian2820Date PreviousDay()
    {
    ...
    /// </summary>
    [Pure]
    public int CountWeeksSince(Persian2820Date other) => MathZ.Divide(CountDaysSince(other), DaysPerWeek);
    ...
    /// </exception>
    [Pure]
    public Persian2820Date PlusWeeks(int weeks) => PlusDays(DaysPerWeek * weeks);
    ...
    /// </summary>
    [Pure]
    public Persian2820Date NextWeek() => PlusDays(DaysPerWeek);
    ...
    /// </summary>
    [Pure]
    public Persian2820Date PreviousWeek() => PlusDays(-DaysPerWeek);
}

public partial struct Persian2820Date // Non-standard math ops
{
    /// <summary>
    ...
    /// range of supported dates.</exception>
    [Pure]
    public Persian2820Date PlusYears(int years)
    {
        var chr = Calendar;
    ...
    /// range of supported dates.</exception>
    [Pure]
    public Persian2820Date PlusYears(int years, out int roundoff)
    {
        var chr = Calendar;
        chr.Schema.GetDateParts(_daysSinceEpoch, out int y, out int m, out int d);
    ...
    /// range of supported dates.</exception>
    [Pure]
    public Persian2820Date PlusMonths(int months)
    {
        var chr = Calendar;
        chr.Schema.GetDateParts(_daysSinceEpoch, out int y, out int m, out int d);
    ...
    /// range of supported dates.</exception>
    [Pure]
    public Persian2820Date PlusMonths(int months, out int roundoff)
    {
        var sch = Calendar.Schema;
        sch.GetDateParts(_daysSinceEpoch, out int y, out int m, out int d);
    ...
    /// </summary>
    [Pure]
    public int CountYearsSince(Persian2820Date other)
    {
        var chr = Calendar;
    ...
    /// </summary>
    [Pure]
    public int CountMonthsSince(Persian2820Date other)
    {
        var chr = Calendar;
        var sch = chr.Schema;
        sch.GetDateParts(_daysSinceEpoch, out int y, out int m, out _);
        ...
        int months = checked(Persian2820Schema.MonthsPerYear * (y - y0) + m - m0);
...
/// </para>
/// <para><see cref="Persian2820Month"/> is an immutable struct.</para>
/// </summary>
public readonly partial struct Persian2820Month :
    IMonth<Persian2820Month>,
    IUnsafeFactory<Persian2820Month>,
    // A month viewed as a finite sequence of days
    IDaySegment<Persian2820Date>,
    ISetMembership<Persian2820Date>,
    // Arithmetic
    ISubtractionOperators<Persian2820Month, Persian2820Month, int>
{ }

public partial struct Persian2820Month // Preamble
{
    ...
    public Persian2820Month(int year, int month)
    {
        // The calendar being regular, no need to use the Scope:
        // > Persian2820Calendar.Instance.Scope.ValidateYearMonth(year, month);
        if (year < StandardScope.MinYear || year > StandardScope.MaxYear)
            ThrowHelpers.ThrowYearOutOfRange(year);
        if (month < 1 || month > Persian2820Schema.MonthsPerYear)
    ...
    /// </summary>
    private Persian2820Month(int monthsSinceEpoch)
    {
        _monthsSinceEpoch = monthsSinceEpoch;
    }

    /// <summary>
    /// Gets the smallest possible value of <see cref="Persian2820Month"/>.
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    /// <returns>The earliest supported month.</returns>
    //
    // MinValue = new(0) = new() = default(Persian2820Month)
    public static Persian2820Month MinValue { get; }

    /// <summary>
    /// Gets the largest possible value of <see cref="Persian2820Month"/>.
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    /// <returns>The latest supported month.</returns>
    public static Persian2820Month MaxValue { get; } = new(MaxMonthsSinceEpoch);
    ...
    public int Year =>
        ...
        1 + _monthsSinceEpoch / Persian2820Schema.MonthsPerYear;
    ...
    {
        var (y, m) = this;
        return FormattableString.Invariant($"{m:D2}/{y:D4} ({Persian2820Calendar.DisplayName})");
    }
    ...
    public void Deconstruct(out int year, out int month)
    {
        ...
        // NB: both dividend and divisor are >= 0.
        year = 1 + MathN.Divide(_monthsSinceEpoch, Persian2820Schema.MonthsPerYear, out int m0);
        month = 1 + m0;
    }
}

public partial struct Persian2820Month // Factories
{
    /// <inheritdoc />
    [Pure]
    public static Persian2820Month Create(int year, int month) => new(year, month);

    /// <summary>
    /// Attempts to create a new instance of the <see cref="Persian2820Month"/>
    /// struct from the specified month components.
    /// </summary>
    [Pure]
    public static Persian2820Month? TryCreate(int year, int month)
    {
        // The calendar being regular, no need to use the PreValidator.
        if (year < StandardScope.MinYear || year > StandardScope.MaxYear
            || month < 1 || month > Persian2820Schema.MonthsPerYear)
        {
            return null;
        }
    ...
    // Explicit implementation: Persian2820Month being a value type, better
    // to use the other TryCreate().
    [Pure]
    static bool IMonth<Persian2820Month>.TryCreate(int year, int month, out Persian2820Month result)
    {
    ...
    /// </summary>
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static Persian2820Month UnsafeCreate(int year, int month)
    {
    ...
    /// </summary>
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static Persian2820Month UnsafeCreate(int monthsSinceEpoch) => new(monthsSinceEpoch);

    [Pure]
    static Persian2820Month IUnsafeFactory<Persian2820Month>.UnsafeCreate(int monthsSinceEpoch) =>
...
public partial struct Persian2820Month // Counting
{
    ...
    /// <inheritdoc />
    [Pure]
    public int CountRemainingMonthsInYear() => Persian2820Schema.MonthsPerYear - Month;
...
public partial struct Persian2820Month // Adjustments
{
    /// <inheritdoc />
    [Pure]
    public Persian2820Month WithYear(int newYear)
    {
        int m = Month;
    ...
    /// <inheritdoc />
    [Pure]
    public Persian2820Month WithMonth(int newMonth)
    {
        int y = Year;
        ...
        if (newMonth < 1 || newMonth > Persian2820Schema.MonthsPerYear)
...
public partial struct Persian2820Month // IDaySegment
{
    /// <summary>
    /// Gets the the start of the current month instance.
    /// </summary>
    public Persian2820Date MinDay
    {
        get
        {
            var (y, m) = this;
    ...
    /// </summary>
    [Pure]
    public IEnumerable<Persian2820Date> ToEnumerable()
    {
        var (y, m) = this;
        var sch = Calendar.Schema;
        int startOfMonth = sch.CountDaysSinceEpoch(y, m, 1);
        ...
        return from daysSinceEpoch
               ...
               select Persian2820Date.UnsafeCreate(daysSinceEpoch);
    }

    [Pure]
    IEnumerable<Persian2820Date> IDaySegment<Persian2820Date>.EnumerateDays() => ToEnumerable();
    ...
    /// </summary>
    [Pure]
    public bool Contains(Persian2820Date date)
    {
        var (y, m) = this;
    ...
    [Pure]
    public Persian2820Date GetDayOfMonth(int dayOfMonth)
    {
        var (y, m) = this;
        var chr = Calendar;
...
public partial struct Persian2820Month // IEquatable
{
    /// <inheritdoc />
    public static bool operator ==(Persian2820Month left, Persian2820Month right) =>
    ...
    /// <inheritdoc />
    [Pure]
    public bool Equals(Persian2820Month other) => _monthsSinceEpoch == other._monthsSinceEpoch;

    /// <inheritdoc />
    [Pure]
    public override bool Equals([NotNullWhen(true)] object? obj) =>
        obj is Persian2820Month month && Equals(month);
...
public partial struct Persian2820Month // IComparable
{
    /// <summary>
    ...
    /// <inheritdoc />
    [Pure]
    public static Persian2820Month Min(Persian2820Month x, Persian2820Month y) => x < y ? x : y;

    /// <inheritdoc />
    [Pure]
    public static Persian2820Month Max(Persian2820Month x, Persian2820Month y) => x > y ? x : y;

    /// <inheritdoc />
    [Pure]
    public int CompareTo(Persian2820Month other) => _monthsSinceEpoch.CompareTo(other._monthsSinceEpoch);

    [Pure]
    int IComparable.CompareTo(object? obj) =>
        obj is null ? 1
        : obj is Persian2820Month month ? CompareTo(month)
        : ThrowHelpers.ThrowNonComparable(typeof(Persian2820Month), obj);
}

public partial struct Persian2820Month // Standard math ops
{
    /// <summary>
    ...
    public static int operator -(Persian2820Month left, Persian2820Month right) => left.CountMonthsSince(right);
    ...
    public static Persian2820Month operator +(Persian2820Month value, int months) => value.PlusMonths(months);
    ...
    public static Persian2820Month operator ++(Persian2820Month value) => value.NextMonth();
    ...
    public static Persian2820Month operator --(Persian2820Month value) => value.PreviousMonth();

    /// <summary>
    /// Counts the number of whole months elapsed since the specified month.
    /// </summary>
    [Pure]
    public int CountMonthsSince(Persian2820Month other) =>
        // No need to use a checked context here. Indeed, the absolute value of
    ...
    /// </exception>
    [Pure]
    public Persian2820Month PlusMonths(int months)
    {
    ...
    /// latest supported month.</exception>
    [Pure]
    public Persian2820Month NextMonth()
    {
        if (_monthsSinceEpoch == MaxMonthsSinceEpoch) ThrowHelpers.ThrowMonthOverflow();
        return new Persian2820Month(_monthsSinceEpoch + 1);
    }
    ...
    /// earliest supported month.</exception>
    [Pure]
    public Persian2820Month PreviousMonth()
    {
...
public partial struct Persian2820Month // Non-standard math ops
{
    /// <summary>
    ...
    [Pure]
    public Persian2820Month PlusYears(int years)
    {
        var (y, m) = this;
        // Exact addition of years to a calendar year.
        int newY = checked(y + years);
    ...
    [Pure]
    Persian2820Month IMonthBase<Persian2820Month>.PlusYears(int years, out int roundoff)
    {
        roundoff = 0;
    ...
    /// </summary>
    [Pure]
    public int CountYearsSince(Persian2820Month other)
    {
        // Exact difference between two calendar years.
...
#region Persian2820Year

/// <summary>
/// Represents the Persian2820 year.
/// <para><i>All</i> years within the range [1..9999] of years are supported.
/// </para>
/// <para><see cref="Persian2820Year"/> is an immutable struct.</para>
/// </summary>
public readonly partial struct Persian2820Year :
    IYear<Persian2820Year>,
    // A year viewed as a finite sequence of months
    IMonthSegment<Persian2820Month>,
    ISetMembership<Persian2820Month>,
    // A year viewed as a finite sequence of days
    IDaySegment<Persian2820Date>,
    ISetMembership<Persian2820Date>,
    // Arithmetic
    ISubtractionOperators<Persian2820Year, Persian2820Year, int>
{ }

public partial struct Persian2820Year // Preamble
{
    ...
    public Persian2820Year(int year)
    {
        if (year < StandardScope.MinYear || year > StandardScope.MaxYear)
            ThrowHelpers.ThrowYearOutOfRange(year);
    ...
    /// <para>This method does NOT validate its parameter.</para>
    /// </summary>
    private Persian2820Year(ushort yearsSinceEpoch)
    {
        _yearsSinceEpoch = yearsSinceEpoch;
    }

    /// <summary>
    /// Gets the smallest possible value of <see cref="Persian2820Year"/>.
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    /// <returns>The earliest supported year.</returns>
    //
    // MinValue = new(1) = new() = default(Persian2820Year)
    public static Persian2820Year MinValue { get; }

    /// <summary>
    /// Gets the largest possible value of <see cref="Persian2820Year"/>.
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    /// <returns>The latest supported year.</returns>
    public static Persian2820Year MaxValue { get; } = new((ushort)MaxYearsSinceEpoch);
    ...
    [Pure]
    public override string ToString() =>
        FormattableString.Invariant($"{Year:D4} ({Persian2820Calendar.DisplayName})");
}

public partial struct Persian2820Year // Factories
{
    /// <inheritdoc />
    [Pure]
    public static Persian2820Year Create(int year) => new(year);

    /// <summary>
    /// Attempts to create a new instance of the <see cref="Persian2820Year"/>
    /// struct from the specified year.
    /// </summary>
    [Pure]
    public static Persian2820Year? TryCreate(int year)
    {
        bool ok = year >= StandardScope.MinYear && year <= StandardScope.MaxYear;
        return ok ? UnsafeCreate(year) : null;
    }

    // Explicit implementation: Persian2820Year being a value type, better
    // to use the other TryCreate().
    [Pure]
    static bool IYear<Persian2820Year>.TryCreate(int year, out Persian2820Year result)
    {
...
public partial struct Persian2820Year // IMonthSegment
{
    ...
    /// </summary>
    public const int MonthCount = Persian2820Schema.MonthsPerYear;

    /// <inheritdoc />
    public Persian2820Month MinMonth => Persian2820Month.UnsafeCreate(Year, 1);

    /// <inheritdoc />
    public Persian2820Month MaxMonth => Persian2820Month.UnsafeCreate(Year, MonthCount);

    /// <inheritdoc />
    [Pure]
    int IMonthSegment<Persian2820Month>.CountMonths() => MonthCount;
    ...
    /// <inheritdoc />
    [Pure]
    public IEnumerable<Persian2820Month> EnumerateMonths()
    {
        int startOfYear = Persian2820Month.UnsafeCreate(Year, 1).MonthsSinceEpoch;

        return from monthsSinceEpoch
               in Enumerable.Range(startOfYear, MonthCount)
               select Persian2820Month.UnsafeCreate(monthsSinceEpoch);
    }
    ...
    /// </summary>
    [Pure]
    public bool Contains(Persian2820Month month) => month.Year == Year;
    ...
    /// is outside the range of valid values.</exception>
    [Pure]
    public Persian2820Month GetMonthOfYear(int month)
    {
        ...
        return Persian2820Month.UnsafeCreate(Year, month);
    }
}

public partial struct Persian2820Year // IDaySegment
{
    /// <summary>
    ...
    /// <inheritdoc />
    [Pure]
    public IEnumerable<Persian2820Date> EnumerateDays()
    {
        var sch = Calendar.Schema;
        int startOfYear = sch.CountDaysSinceEpoch(Year, 1);
        int daysInYear = sch.CountDaysInYear(Year);
    ...
    /// </summary>
    [Pure]
    public bool Contains(Persian2820Date date) => date.Year == Year;
    ...
    /// is outside the range of valid values.</exception>
    [Pure]
    public Persian2820Date GetDayOfYear(int dayOfYear)
    {
        var chr = Calendar;
...
public partial struct Persian2820Year // IEquatable
{
    /// <inheritdoc />
    public static bool operator ==(Persian2820Year left, Persian2820Year right) =>
    ...
    /// <inheritdoc />
    [Pure]
    public bool Equals(Persian2820Year other) => _yearsSinceEpoch == other._yearsSinceEpoch;

    /// <inheritdoc />
    [Pure]
    public override bool Equals([NotNullWhen(true)] object? obj) =>
        obj is Persian2820Year year && Equals(year);
...
public partial struct Persian2820Year // IComparable
{
    /// <summary>
    /// Compares the two specified instances to see if the left one is strictly
    /// earlier than the right one.
    ...
    /// <inheritdoc />
    [Pure]
    public static Persian2820Year Min(Persian2820Year x, Persian2820Year y) => x < y ? x : y;

    /// <inheritdoc />
    [Pure]
    public static Persian2820Year Max(Persian2820Year x, Persian2820Year y) => x > y ? x : y;

    /// <inheritdoc />
    [Pure]
    public int CompareTo(Persian2820Year other) =>
        _yearsSinceEpoch.CompareTo(other._yearsSinceEpoch);

    [Pure]
    int IComparable.CompareTo(object? obj) =>
        obj is null ? 1
        : obj is Persian2820Year year ? CompareTo(year)
        : ThrowHelpers.ThrowNonComparable(typeof(Persian2820Year), obj);
}

public partial struct Persian2820Year // Math ops
{
    /// <summary>
    ...
    public static int operator -(Persian2820Year left, Persian2820Year right) => left.CountYearsSince(right);
    ...
    public static Persian2820Year operator +(Persian2820Year value, int years) => value.PlusYears(years);
    ...
    public static Persian2820Year operator ++(Persian2820Year value) => value.NextYear();
    ...
    public static Persian2820Year operator --(Persian2820Year value) => value.PreviousYear();

    /// <summary>
    /// Counts the number of whole years elapsed since the specified year.
    /// </summary>
    [Pure]
    public int CountYearsSince(Persian2820Year other) =>
        // No need to use a checked context here. Indeed, the absolute value of
    ...
    /// </exception>
    [Pure]
    public Persian2820Year PlusYears(int years)
    {
        ...
        return new Persian2820Year((ushort)yearsSinceEpoch);
    }
    ...
    /// latest supported year.</exception>
    [Pure]
    public Persian2820Year NextYear()
    {
        if (_yearsSinceEpoch == MaxYearsSinceEpoch) ThrowHelpers.ThrowYearOverflow();
        return new Persian2820Year((ushort)(_yearsSinceEpoch + 1));
    }
    ...
    /// earliest supported year.</exception>
    [Pure]
    public Persian2820Year PreviousYear()
    {
