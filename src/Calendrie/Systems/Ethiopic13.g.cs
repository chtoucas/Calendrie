...
public sealed partial class Ethiopic13Calendar : CalendarSystem<Ethiopic13Date>
{
    ...
    /// </summary>
    private static StandardScope CreateScope(Coptic13Schema schema) => new(schema, Epoch);
}
...
public partial struct Ethiopic13Date // Preamble
{
    ...
    private static readonly Range<DayNumber> s_Domain = Ethiopic13Calendar.UnderlyingScope.Domain;
