...
public sealed partial class Ethiopic13Calendar : CalendarSystem<Ethiopic13Date>
{
    ...
    /// </summary>
    public DateAdjuster<Ethiopic13Date> Adjuster { get; }
...
public partial struct Ethiopic13Date // Preamble
{
    ...
    /// </summary>
    public static DateAdjuster<Ethiopic13Date> Adjuster => Ethiopic13Calendar.Instance.Adjuster;
    ...
    private static Coptic13Schema Schema => Ethiopic13Calendar.UnderlyingSchema;
...
public partial struct Ethiopic13Date // Adjustments
{
    ...
    /// <inheritdoc />
    [Pure]
    public Ethiopic13Date WithYear(int newYear) => Adjuster.AdjustYear(this, newYear);

    /// <inheritdoc />
    [Pure]
    public Ethiopic13Date WithMonth(int newMonth) => Adjuster.AdjustMonth(this, newMonth);

    /// <inheritdoc />
    [Pure]
    public Ethiopic13Date WithDay(int newDay) => Adjuster.AdjustDay(this, newDay);

    /// <inheritdoc />
    [Pure]
    public Ethiopic13Date WithDayOfYear(int newDayOfYear) => Adjuster.AdjustDayOfYear(this, newDayOfYear);
