...
public partial struct Ethiopic13Date // Non-standard math ops
{
    ...
    /// </summary>
    [Pure]
    public int CountMonthsSince(Ethiopic13Date other) => Calendar.CountMonthsBetween(other, this);
    ...
    /// </summary>
    [Pure]
    public Ethiopic13Date PlusMonths(int months) => Calendar.AddMonths(this, months);

    /// <summary>
    /// Counts the number of years elapsed since the specified date.
    /// </summary>
    [Pure]
    public int CountYearsSince(Ethiopic13Date other) => Calendar.CountYearsBetween(other, this);
    ...
    /// </summary>
    [Pure]
    public Ethiopic13Date PlusYears(int years) => Calendar.AddYears(this, years);
}
