...
public partial struct Egyptian13Year // IMonthSegment
{
    ...
    /// <inheritdoc />
    [Pure]
    public Segment<Egyptian13Month> ToMonthRange() => Range.StartingAt(MinMonth, MonthCount);
...
public partial struct Egyptian13Year // IDaySegment
{
    ...
    public Segment<Egyptian13Date> ToDayRange()
    {
        ...
        return Range.StartingAt(Egyptian13Date.UnsafeCreate(startOfYear), DayCount);
    }
