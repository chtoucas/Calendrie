...
public partial class ZoroastrianCalendar // Math
{
    ...
    /// range of supported dates.</exception>
    [Pure]
    internal ZoroastrianDate AddYears(int y, int m, int d, int years, out int roundoff)
    {
        var sch = Schema;
    ...
    /// range of supported dates.</exception>
    [Pure]
    internal ZoroastrianDate AddMonths(int y, int m, int d, int months, out int roundoff)
    {
        // Exact addition of months to a calendar month.
        int newM = 1 + MathZ.Modulo(
            checked(m - 1 + months), Egyptian12Schema.MonthsPerYear, out int years);
...
#region ZoroastrianClock

/// <summary>
/// Represents a clock for the Zoroastrian calendar.
/// <para>This class cannot be inherited.</para>
/// </summary>
public sealed partial class ZoroastrianClock : IClock
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ZoroastrianClock"/> class.
    /// </summary>
    /// <exception cref="ArgumentNullException"><paramref name="clock"/> is
    /// <see langword="null"/>.</exception>
    public ZoroastrianClock(IClock clock)
    {
    ...
    /// <summary>
    /// Gets an instance of the <see cref="ZoroastrianClock"/> class for the
    /// system clock using the current time zone setting on this machine.
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    public static ZoroastrianClock Local { get; } = new(LocalSystemClock.Instance);
    ...
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    public static ZoroastrianClock Utc { get; } = new(UtcSystemClock.Instance);
    ...
    /// <summary>
    /// Obtains a <see cref="ZoroastrianDate"/> value representing the current date.
    /// </summary>
    [Pure]
    public ZoroastrianDate GetCurrentDate() => ZoroastrianDate.FromAbsoluteDate(Clock.Today());

    /// <summary>
    /// Obtains a <see cref="ZoroastrianMonth"/> value representing the current month.
    /// </summary>
    [Pure]
    public ZoroastrianMonth GetCurrentMonth() => ZoroastrianMonth.FromDate(GetCurrentDate());

    /// <summary>
    /// Obtains a <see cref="ZoroastrianYear"/> value representing the current year.
    /// </summary>
    [Pure]
    public ZoroastrianYear GetCurrentYear() => ZoroastrianYear.FromDate(GetCurrentDate());
}
...
public partial struct ZoroastrianDate // Non-standard math ops
{
    ...
    /// range of supported dates.</exception>
    [Pure]
    public ZoroastrianDate PlusYears(int years, out int roundoff)
    {
        var chr = Calendar;
        chr.Schema.GetDateParts(_daysSinceEpoch, out int y, out int m, out int d);
    ...
    /// range of supported dates.</exception>
    [Pure]
    public ZoroastrianDate PlusMonths(int months, out int roundoff)
    {
        var sch = Calendar.Schema;
        sch.GetDateParts(_daysSinceEpoch, out int y, out int m, out int d);
...
public partial struct ZoroastrianMonth // Conversions
{
    /// <summary>
    /// Creates a new instance of the <see cref="ZoroastrianMonth"/> struct
    ...
    /// </summary>
    [Pure]
    public static ZoroastrianMonth FromMonthsSinceEpoch(int monthsSinceEpoch)
    {
    ...
    /// </summary>
    [Pure]
    public static ZoroastrianMonth FromDate(ZoroastrianDate date)
    {
        var (y, m, _) = date;
...
public partial struct ZoroastrianYear // Conversions
{
    ...
    /// </summary>
    [Pure]
    public static ZoroastrianYear FromMonth(ZoroastrianMonth month) => UnsafeCreate(month.Year);
    ...
    /// </summary>
    [Pure]
    public static ZoroastrianYear FromDate(ZoroastrianDate date) => UnsafeCreate(date.Year);
}
...
public partial struct ZoroastrianYear // IDaySegment
{
    ...
    public Range<ZoroastrianDate> ToDayRange()
    {
        ...
        return Range.StartingAt(ZoroastrianDate.UnsafeCreate(startOfYear), daysInYear);
    }
