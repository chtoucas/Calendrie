...
public partial struct ZoroastrianDate // Non-standard math ops
{
    ...
    /// range of supported dates.</exception>
    [Pure]
    private static ZoroastrianDate AddYears(Egyptian12Schema sch, int y, int m, int d, int years)
    {
    ...
    /// range of supported dates.</exception>
    [Pure]
    private static ZoroastrianDate AddMonths(Egyptian12Schema sch, int y, int m, int d, int months)
    {
...
public partial struct ZoroastrianMonth // Non-standard math ops
{
    ...
    /// a new month.
    /// <para>In the particular case of the Zoroastrian calendar, this
