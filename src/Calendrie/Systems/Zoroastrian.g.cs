...
public partial struct ZoroastrianDate // Preamble
{
    ...
    /// <summary>
    /// Gets the earliest possible value of a <see cref="ZoroastrianDate"/>.
    ...
    /// <summary>
    /// Gets the latest possible value of a <see cref="ZoroastrianDate"/>.
    /// <para>This static property is thread-safe.</para>
    /// </summary>
...
public partial struct ZoroastrianDate // Standard math ops
{
    ...
    /// <inheritdoc />
    [Pure]
    public ZoroastrianDate AddWeeks(int weeks) => PlusDays(DaysInWeek * weeks);
...
public partial struct ZoroastrianDate // Non-standard math ops
{
    ...
    public int CountMonthsSince(ZoroastrianDate other)
    {
        ...
        int months = checked(ZoroastrianCalendar.MonthsInYear * (y - y0) + m - m0);
    ...
    private static ZoroastrianDate AddMonths(Egyptian12Schema sch, int y, int m, int d, int months)
    {
        ...
        int newM = 1 + MathZ.Modulo(checked(m - 1 + months), ZoroastrianCalendar.MonthsInYear, out int y0);
