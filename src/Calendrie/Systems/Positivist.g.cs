...
public partial struct PositivistDate // Non-standard math ops
{
    ...
    public int CountMonthsSince(PositivistDate other)
    {
        ...
        int months = checked(PositivistSchema.MonthsInYear * (y - y0) + m - m0);
    ...
    private static PositivistDate AddMonths(PositivistSchema sch, int y, int m, int d, int months)
    {
        ...
        int newM = 1 + MathZ.Modulo(checked(m - 1 + months), PositivistSchema.MonthsInYear, out int y0);
...
public partial struct PositivistMonth // Preamble
{
    ...
    public PositivistMonth(int year, int month)
    {
        ...
        if (month < 1 || month > PositivistSchema.MonthsInYear)
    ...
    public int Year =>
        ...
        1 + _monthsSinceEpoch / PositivistSchema.MonthsInYear;
    ...
    public void Deconstruct(out int year, out int month)
    {
        ...
        // NB: both dividend and divisor are >= 0.
        year = 1 + MathN.Divide(_monthsSinceEpoch, PositivistSchema.MonthsInYear, out int m0);
        month = 1 + m0;
    }
}
...
public partial struct PositivistMonth // Factories
{
    ...
    public static PositivistMonth? TryCreate(int year, int month)
    {
        ...
        if (year < StandardScope.MinYear || year > StandardScope.MaxYear
            || month < 1 || month > PositivistSchema.MonthsInYear)
        {
            return null;
        }
    ...
    private static int CountMonthsSinceEpoch(int y, int m) =>
        ...
        PositivistSchema.MonthsInYear * (y - 1) + m - 1;
}
...
public partial struct PositivistMonth // Counting
{
    ...
    /// <inheritdoc />
    [Pure]
    public int CountRemainingMonthsInYear() => PositivistSchema.MonthsInYear - Month;
...
public partial struct PositivistMonth // Adjustments
{
    ...
    public PositivistMonth WithMonth(int newMonth)
    {
        ...
        if (newMonth < 1 || newMonth > PositivistSchema.MonthsInYear)
...
public partial struct PositivistYear // IMonthSegment
{
    ...
    /// </summary>
    public const int MonthCount = PositivistSchema.MonthsInYear;
