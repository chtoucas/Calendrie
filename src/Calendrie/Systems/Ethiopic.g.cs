...
public sealed partial class EthiopicCalendar : CalendarSystem<EthiopicDate>
{
    ...
    /// </summary>
    public EthiopicCalendar() : this(CreateScope(new Coptic12Schema())) { }
    ...
    /// </summary>
    private static StandardScope CreateScope(Coptic12Schema schema) => new(schema, Epoch);
}
...
public partial struct EthiopicDate // Preamble
{
    ...
    private static readonly Range<DayNumber> s_Domain = EthiopicCalendar.UnderlyingScope.Domain;
