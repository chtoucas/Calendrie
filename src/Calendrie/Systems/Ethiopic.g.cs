...
public partial struct EthiopicMonth // Conversions
{
    /// <summary>
    /// Creates a new instance of the <see cref="EthiopicMonth"/> struct
    ...
    /// </summary>
    [Pure]
    public static EthiopicMonth FromMonthsSinceEpoch(int monthsSinceEpoch)
    {
    ...
    /// </summary>
    [Pure]
    public static EthiopicMonth FromDate(EthiopicDate date)
    {
        var (y, m, _) = date;
...
public partial struct EthiopicYear // Conversions
{
    ...
    /// </summary>
    [Pure]
    public static EthiopicYear FromMonth(EthiopicMonth month) => UnsafeCreate(month.Year);
    ...
    /// </summary>
    [Pure]
    public static EthiopicYear FromDate(EthiopicDate date) => UnsafeCreate(date.Year);
}
