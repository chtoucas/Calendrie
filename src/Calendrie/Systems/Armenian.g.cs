...
public sealed partial class ArmenianCalendar : CalendarSystem<ArmenianDate>
{
    ...
    /// </summary>
    private static StandardScope CreateScope(Egyptian12Schema schema) => new(schema, Epoch);
}
...
public partial struct ArmenianDate // Preamble
{
    ...
    private static readonly Range<DayNumber> s_Domain = ArmenianCalendar.UnderlyingScope.Domain;
