...
public partial struct ArmenianDate // Non-standard math ops
{
    ...
    /// range of supported dates.</exception>
    [Pure]
    private static ArmenianDate AddYears(Egyptian12Schema sch, int y, int m, int d, int years)
    {
    ...
    /// range of supported dates.</exception>
    [Pure]
    private static ArmenianDate AddMonths(Egyptian12Schema sch, int y, int m, int d, int months)
    {
