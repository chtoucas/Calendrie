...
public sealed partial class GregorianClock : IClock
{
    ...
    /// <summary>
    /// Gets an instance of the <see cref="GregorianClock"/> class for the
    /// system clock using the current time zone setting on this machine.
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    public static GregorianClock Local { get; } = new(LocalSystemClock.Instance);
    ...
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    public static GregorianClock Utc { get; } = new(UtcSystemClock.Instance);
    ...
    /// </summary>
    [Pure]
    public GregorianDate GetCurrentDate() => GregorianDate.FromAbsoluteDate(Clock.Today());

    /// <summary>
    /// Obtains a <see cref="GregorianMonth"/> value representing the current month.
    /// </summary>
    [Pure]
    public GregorianMonth GetCurrentMonth() => GregorianMonth.FromDate(GetCurrentDate());

    /// <summary>
    /// Obtains a <see cref="GregorianYear"/> value representing the current year.
    /// </summary>
    [Pure]
    public GregorianYear GetCurrentYear() => GregorianYear.FromDate(GetCurrentDate());
}
