...
public sealed class GregorianDateMath : DateMath<GregorianDate>
{
    ...
    /// <summary>
    /// Gets an instance of the <see cref="GregorianDateMath"/> class
    /// using the default strategy.
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    public static GregorianDateMath Default { get; } = new(AdditionRule.Truncate);
}
