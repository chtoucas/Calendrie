...
public partial struct GregorianYear // Preamble
{
    ...
    public override string ToString()
    {
        return _yearsSinceEpoch >= 0
            ...
            : FormattableString.Invariant($"{getBCEYear(Year):D4} BCE ({GregorianCalendar.DisplayName})");
...
public partial struct GregorianYear // IDaySegment
{
    ...
    public Segment<GregorianDate> ToDayRange()
    {
        ...
        return Segment.StartingAt(GregorianDate.UnsafeCreate(startOfYear), daysInYear);
    }
