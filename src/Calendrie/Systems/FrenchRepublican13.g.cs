...
#region FrenchRepublican13Clock

/// <summary>
/// Represents a clock for the French Republican calendar.
/// <para>This class cannot be inherited.</para>
/// </summary>
public sealed partial class FrenchRepublican13Clock : IClock
{
    /// <summary>
    /// Initializes a new instance of the <see cref="FrenchRepublican13Clock"/> class.
    /// </summary>
    /// <exception cref="ArgumentNullException"><paramref name="clock"/> is
    /// <see langword="null"/>.</exception>
    public FrenchRepublican13Clock(IClock clock)
    {
    ...
    /// <summary>
    /// Gets an instance of the <see cref="FrenchRepublican13Clock"/> class for the
    /// system clock using the current time zone setting on this machine.
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    public static FrenchRepublican13Clock Local { get; } = new(LocalSystemClock.Instance);
    ...
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    public static FrenchRepublican13Clock Utc { get; } = new(UtcSystemClock.Instance);
    ...
    /// <summary>
    /// Obtains a <see cref="FrenchRepublican13Date"/> value representing the current date.
    /// </summary>
    [Pure]
    public FrenchRepublican13Date GetCurrentDate() => FrenchRepublican13Date.FromAbsoluteDate(Clock.Today());

    /// <summary>
    /// Obtains a <see cref="FrenchRepublican13Month"/> value representing the current month.
    /// </summary>
    [Pure]
    public FrenchRepublican13Month GetCurrentMonth() => FrenchRepublican13Month.FromDate(GetCurrentDate());

    /// <summary>
    /// Obtains a <see cref="FrenchRepublican13Year"/> value representing the current year.
    /// </summary>
    [Pure]
    public FrenchRepublican13Year GetCurrentYear() => FrenchRepublican13Year.FromDate(GetCurrentDate());
}
