...
/// </summary>
internal sealed class GregorianArithmetic : ICalendricalArithmetic
{
    /// <summary>
    ...
    /// </summary>
    private const int MinYear = GregorianScope.MinYear;

    /// <summary>
    /// Represents the latest supported year.
    /// <para>This field is a constant equal to 999_999.</para>
    /// </summary>
    private const int MaxYear = GregorianScope.MaxYear;
    ...
    public Yemoda AddMonths(int y, int m, int d, int months, out int roundoff)
    {
        ...
        int daysInMonth = GregorianFormulae.CountDaysInMonth(newY, newM);
        roundoff = Math.Max(0, d - daysInMonth);
