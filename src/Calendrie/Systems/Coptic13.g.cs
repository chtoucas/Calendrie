...
public sealed partial class Coptic13Calendar : CalendarSystem<Coptic13Date>
{
    ...
    {
        UnderlyingSchema = (Coptic13Schema)Schema;
    }
...
public readonly partial struct Coptic13Date :
    ...
    IFixedDateFactory<Coptic13Date>,
...
public partial struct Coptic13Date // Preamble
{
    ...
    /// </summary>
    private static Coptic13Schema Schema => Calendar.UnderlyingSchema;
    ...
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    private static DateAdjuster<Coptic13Date> Adjuster => Calendar.Adjuster;
...
public partial struct Coptic13Date // Factories
{
    ...
    /// <inheritdoc />
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    static Coptic13Date IFixedDateFactory<Coptic13Date>.FromDaysSinceEpochUnchecked(int daysSinceEpoch) =>
        new(daysSinceEpoch);
}
...
public partial struct Coptic13Date // Adjustments
{
    ...
    /// <inheritdoc />
    [Pure]
    public Coptic13Date WithYear(int newYear) => Adjuster.AdjustYear(this, newYear);

    /// <inheritdoc />
    [Pure]
    public Coptic13Date WithMonth(int newMonth) => Adjuster.AdjustMonth(this, newMonth);

    /// <inheritdoc />
    [Pure]
    public Coptic13Date WithDay(int newDay) => Adjuster.AdjustDay(this, newDay);

    /// <inheritdoc />
    [Pure]
    public Coptic13Date WithDayOfYear(int newDayOfYear) => Adjuster.AdjustDayOfYear(this, newDayOfYear);
