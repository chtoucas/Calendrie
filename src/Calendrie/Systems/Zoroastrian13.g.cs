...
public partial class Zoroastrian13Calendar // Math
{
    ...
    /// range of supported dates.</exception>
    [Pure]
    internal Zoroastrian13Date AddYears(int y, int m, int d, int years, out int roundoff)
    {
        var sch = Schema;
    ...
    /// range of supported dates.</exception>
    [Pure]
    internal Zoroastrian13Date AddMonths(int y, int m, int d, int months, out int roundoff)
    {
        // Exact addition of months to a calendar month.
        int newM = 1 + MathZ.Modulo(
            checked(m - 1 + months), Egyptian13Schema.MonthsPerYear, out int years);
...
public partial struct Zoroastrian13Date // Non-standard math ops
{
    ...
    /// range of supported dates.</exception>
    [Pure]
    public Zoroastrian13Date PlusYears(int years, out int roundoff)
    {
        var chr = Calendar;
        chr.Schema.GetDateParts(_daysSinceEpoch, out int y, out int m, out int d);
    ...
    /// range of supported dates.</exception>
    [Pure]
    public Zoroastrian13Date PlusMonths(int months, out int roundoff)
    {
        var sch = Calendar.Schema;
        sch.GetDateParts(_daysSinceEpoch, out int y, out int m, out int d);
...
#region Zoroastrian13DateMath

/// <summary>
/// Provides non-standard mathematical operations for the
/// <see cref="Zoroastrian13Date"/> type.
/// <para>This class allows to customize the <see cref="AdditionRule"/> strategy.
/// </para>
/// </summary>
public sealed class Zoroastrian13DateMath : DateMath<Zoroastrian13Date>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Zoroastrian13DateMath"/> class.
    /// </summary>
    ...
    public Zoroastrian13DateMath(AdditionRule rule) : base(rule) { }

    /// <summary>
    /// Gets an instance of the <see cref="Zoroastrian13DateMath"/> class
    /// using the default strategy.
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    public static Zoroastrian13DateMath Default { get; } = new(AdditionRule.Truncate);
}
...
public partial struct Zoroastrian13Year // Conversions
{
    /// <summary>
    /// Creates a new instance of the <see cref="Zoroastrian13Year"/> struct
...
public partial struct Zoroastrian13Year // IDaySegment
{
    ...
    public Range<Zoroastrian13Date> ToDayRange()
    {
        ...
        return Range.StartingAt(Zoroastrian13Date.UnsafeCreate(startOfYear), daysInYear);
    }
