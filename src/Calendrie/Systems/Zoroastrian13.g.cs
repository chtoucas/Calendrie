...
public sealed partial class Zoroastrian13Calendar : CalendarSystem<Zoroastrian13Date>
{
    ...
    /// </summary>
    private Zoroastrian13Calendar() : this(CreateScope(new Egyptian13Schema())) { }
    ...
    public static Zoroastrian13Calendar Instance => Singleton.Instance;
...
public partial struct Zoroastrian13Date // Preamble
{
    ...
    private static readonly int s_EpochDaysSinceZero = Zoroastrian13Calendar.UnderlyingScope.Epoch.DaysSinceZero;

    /// <summary>Represents the minimum value of <see cref="_daysSinceEpoch"/>.</summary>
    private static readonly int s_MinDaysSinceEpoch = Zoroastrian13Calendar.UnderlyingScope.MinDaysSinceEpoch;
    /// <summary>Represents the maximum value of <see cref="_daysSinceEpoch"/>.</summary>
    private static readonly int s_MaxDaysSinceEpoch = Zoroastrian13Calendar.UnderlyingScope.MaxDaysSinceEpoch;
    ...
    private static Egyptian13Schema Schema => Zoroastrian13Calendar.UnderlyingSchema;

    /// <summary>
    /// Gets the calendar scope.
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    private static StandardScope Scope => Zoroastrian13Calendar.UnderlyingScope;

    /// <summary>
    /// Gets the date adjuster.
    /// <para>This static property is thread-safe.</para>
    /// </summary>
    private static DateAdjuster<Zoroastrian13Date> Adjuster => Zoroastrian13Calendar.Instance.Adjuster;
...
public partial struct Zoroastrian13Date // Factories
{
    ...
    static Zoroastrian13Date IFixedDateFactory<Zoroastrian13Date>.FromDayNumberUnchecked(DayNumber dayNumber) =>
        new(dayNumber.DaysSinceZero - s_EpochDaysSinceZero);

    /// <inheritdoc />
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    static Zoroastrian13Date IFixedDateFactory<Zoroastrian13Date>.FromDaysSinceEpochUnchecked(int daysSinceEpoch) =>
        new(daysSinceEpoch);
}
...
public partial struct Zoroastrian13Date // Adjustments
{
    ...
    /// <inheritdoc />
    [Pure]
    public Zoroastrian13Date WithYear(int newYear) => Adjuster.AdjustYear(this, newYear);

    /// <inheritdoc />
    [Pure]
    public Zoroastrian13Date WithMonth(int newMonth) => Adjuster.AdjustMonth(this, newMonth);

    /// <inheritdoc />
    [Pure]
    public Zoroastrian13Date WithDay(int newDay) => Adjuster.AdjustDay(this, newDay);

    /// <inheritdoc />
    [Pure]
    public Zoroastrian13Date WithDayOfYear(int newDayOfYear) => Adjuster.AdjustDayOfYear(this, newDayOfYear);

    /// <inheritdoc />
    [Pure]
    public Zoroastrian13Date Previous(DayOfWeek dayOfWeek) => Adjuster.Previous(this, dayOfWeek);

    /// <inheritdoc />
    [Pure]
    public Zoroastrian13Date PreviousOrSame(DayOfWeek dayOfWeek) => Adjuster.PreviousOrSame(this, dayOfWeek);

    /// <inheritdoc />
    [Pure]
    public Zoroastrian13Date Nearest(DayOfWeek dayOfWeek) => Adjuster.Nearest(this, dayOfWeek);

    /// <inheritdoc />
    [Pure]
    public Zoroastrian13Date NextOrSame(DayOfWeek dayOfWeek) => Adjuster.NextOrSame(this, dayOfWeek);

    /// <inheritdoc />
    [Pure]
    public Zoroastrian13Date Next(DayOfWeek dayOfWeek) => Adjuster.Next(this, dayOfWeek);
}
