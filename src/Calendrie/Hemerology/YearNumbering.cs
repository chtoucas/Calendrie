...
public partial class YearNumbering // Decades, centuries, millennia; default (chronological) numbering.
{
    ...
    /// <summary>
    /// Obtains the decade of the century from the specified year and also
    /// returns the century and the year of the decade in output parameters.
    /// </summary>
    [Pure]
    ...
    /// <summary>
    /// Obtains the decade from the specified year and also returns the year of
    /// the decade in an output parameter.
    ...
    /// <summary>
    /// Obtains the century from the specified year and also returns the year of
    /// the century in an output parameter.
    ...
    /// <summary>
    /// Obtains the millennium from the specified year and also returns the year
    /// of the millennium in an output parameter.
...
public partial class YearNumbering // Decades, centuries, millennia; ISO numbering.
{
    ...
    /// <summary>
    /// Obtains the ISO decade of the century from the specified year and also
    /// returns the century and the year of the decade in output parameters.
    /// </summary>
    [Pure]
    ...
    /// <summary>
    /// Obtains the ISO decade from the specified year and also returns the year
    /// of the decade in an output parameter.
    ...
    /// <summary>
    /// Obtains the ISO century from the specified year and also returns the year
    /// of the century in an output parameter.
    ...
    /// <summary>
    /// Obtains the ISO millennium from the specified year and also returns the
    /// year of the millennium in an output parameter.
    ...
    /// <summary>
    /// Obtains the year from the specified ISO millennium and year of the
    /// millennium.
    /// </summary>
    [Pure]
