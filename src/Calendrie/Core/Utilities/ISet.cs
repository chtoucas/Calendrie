...
/// <summary>
/// Defines a <i>set membership relation</i> with an object of type
/// <typeparamref name="T"/>.
/// </summary>
/// <typeparam name="T">The type of object to test for set membership.
/// </typeparam>
...
/// </summary>
/// <typeparam name="TOther">The type of object to test for set equality.
/// </typeparam>
public interface ISetEquatable<in TOther>
{
    /// <summary>
    /// Determines whether this set and <paramref name="other"/> contains the
    /// same elements.
    /// </summary>
...
/// <typeparamref name="TOther"/>.
/// </summary>
/// <typeparam name="TOther">The type of object to test for set inclusion.
/// </typeparam>
...
/// <summary>
/// Defines a <i>set equality relation</i> and a <i>set inclusion relation</i>
/// (strict and large) with an object of type <typeparamref name="TOther"/>.
/// </summary>
...
{
    /// <summary>
    /// Determines whether this set is a proper (strict) subset of
    /// <paramref name="other"/>.
    /// </summary>
    /// <exception cref="ArgumentNullException"><paramref name="other"/> is
    /// <see langword="null"/>.</exception>
    ...
    /// <summary>
    /// Determines whether this set is a proper (strict) superset of
    /// <paramref name="other"/>.
    /// </summary>
    /// <exception cref="ArgumentNullException"><paramref name="other"/> is
    /// <see langword="null"/>.</exception>
