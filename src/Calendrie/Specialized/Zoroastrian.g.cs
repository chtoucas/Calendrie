...
/// </summary>
internal static class ZoroastrianScope
{
    // WARNING: the order in which the static fields are written is __important__.

    /// <summary>
    /// Represents the schema underlying the <see cref="ZoroastrianCalendar"/>
    /// calendar.
    /// </summary>
    //
    ...
    /// </summary>
    public static StandardScope Create() => Create(new Egyptian12Schema());

    /// <summary>
    /// Creates a new instance of the StandardScope class suitable for use
    /// with <see cref="ZoroastrianCalendar"/>.
    /// </summary>
    private static StandardScope Create(Egyptian12Schema schema) => new(schema, DayZero.Zoroastrian);
}
...
public partial struct ZoroastrianDate // Preamble
{
    ...
    private static readonly int s_EpochDaysSinceZero = ZoroastrianScope.Instance.Epoch.DaysSinceZero;
    ...
    private static readonly int s_MinDaysSinceEpoch = ZoroastrianScope.Instance.MinDaysSinceEpoch;
    /// <summary>Represents the maximum value of <see cref="_daysSinceEpoch"/>.</summary>
    private static readonly int s_MaxDaysSinceEpoch = ZoroastrianScope.Instance.MaxDaysSinceEpoch;
