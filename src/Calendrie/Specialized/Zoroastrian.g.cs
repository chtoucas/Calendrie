...
public sealed partial class ZoroastrianCalendar : SpecialCalendar<ZoroastrianDate>
{
    ...
    {
        Adjuster = new SpecialAdjuster<ZoroastrianDate>(this);
    }

    /// <summary>
    /// Gets the date adjuster.
    /// </summary>
    public SpecialAdjuster<ZoroastrianDate> Adjuster { get; }
...
public partial struct ZoroastrianDate // Preamble
{
    ...
    private static readonly int s_EpochDaysSinceZero = ZoroastrianCalendar.Epoch.DaysSinceZero;
    ...
    /// </summary>
    public static SpecialAdjuster<ZoroastrianDate> Adjuster => ZoroastrianCalendar.Instance.Adjuster;
