...
public enum CalendricalFamily
{
    ...
    /// <summary>
    /// The calendar cycle is based upon the position of Earth on its revolution around the Sun.
    ...
    /// <summary>
    /// The calendar tries to maintain synchronicity with both the lunar and the solar cycles.
    /// </summary>
    Lunisolar,
}
